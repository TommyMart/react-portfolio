    ...
    <section id="intro">
      ...
      <div className="introContent">
        ...
        <span className="introText">
          I'm <span className="introName">Tom Martin</span> <br />A Junior Full
          Stack Developer.
        </span>
        <p className="introPara">
          A passionate junior full-stack developer dedicated to crafting{" "}
          <b>
            <i>robust, dynamic, and intuitive </i>
          </b>
          applications that solve user problems and elevate experiences.
        </p>
        ...
        <div className="techLogoWrapper">
          ...
          <div className="logoLinks">
            <a
              href="https://github.com/TommyMart"
              target="_blank"
            ...
            <a
              href={"https://www.linkedin.com/in/tom-martin-9b24a4103"}
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <div className="introButtons">
            <a href="/TomMartinResume.pdf" download>
              <button className="btn">
                <img src={download} alt="suitcase" className="suitcase" />
                Resume
              </button>
            </a>
            {/* <button className='btn' onClick={onButtonClick}><img src={download} alt='suitcase' className='suitcase'/>Resume</button> */}
            <a href="mailto:thomas.h.martin89@gmail.com">
              <button className="btn">
                <img src={mail} alt="suitcase" className="suitcase" />
                Contact Me
              </button>
            </a>
          </div>
